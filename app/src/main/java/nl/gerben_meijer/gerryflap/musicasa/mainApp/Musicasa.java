...
public class Musicasa extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_musicasa);
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            ...
            case 4:
                ...
                break;
            case 5:
                mTitle = getString(R.string.upload);
                break;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.musicasa, menu);
            restoreActionBar();
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_musicasa, container, false);
            return rootView;
        }
